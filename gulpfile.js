...
gulp.task('dev', gulp.series('clean', 'html:build', 'fonts:build', 'js:dev', 'image:build', 'style:dev' , 'audio:build'));

gulp.task('build', gulp.series('clean', 'html:build', 'fonts:build', 'js:build', 'image:build', 'style:build', 'audio:build'));
...
gulp.task('watch', function () {
    ...
    watch(path.watch.audio, gulp.series('audio:build'));
